  ...
  return (
    <header>
      <div className='flex flex-grow justify-between'>
        <HeaderItem title='WELCOME TO LYNX' />
        <div>
        <HeaderItem title='+(976) 99112233'/>
        </div>
      </div>
      <div className=''>
        <h1 className='text-4xl font-bold'>LYNX</h1>
        <p className='text-xs'>Find, Eat, Rate</p>
        <form>
        ...
        <div id="dropdown" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
          <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
            ...
            <li>
             ...
             <HeaderItem title='Signup' />
             </div>
             </div>
              
              </form>
              <div className='flex justify-around'>
              <HeaderItem title='CATEGORY' />
              <HeaderItem title='FIND RESTAURANTS' />
              <HeaderItem title='BLOG' />
              <HeaderItem title='RECIPE' />
